...
describe('Sprint 24: Version and Health', () => {
  ...
  test('GET /health returns v0.24.0', async () => {
  ...
  test('GET /ready reports ready with v0.24.0', async () => {
  ...
  test('GET /.well-known/agent-card.json returns v0.24.0', async () => {
  ...
  test('package.json version is 0.24.0', () => {
