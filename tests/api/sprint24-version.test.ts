...
describe('Sprint 24: Version and Health', () => {
  ...
  test('GET /ready reports ready with v0.30.0', async () => {
  ...
  test('GET /.well-known/agent-card.json returns v0.30.0', async () => {
  ...
  test('package.json version is 0.30.0', () => {
    const pkg = require('../../package.json');
    expect(pkg.version).toBe('0.30.0');
  });
});
