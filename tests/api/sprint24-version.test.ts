...
describe('Sprint 24: Version and Health', () => {
  ...
  test('GET /health returns v0.27.0', async () => {
  ...
  test('GET /ready reports ready with v0.27.0', async () => {
  ...
  test('GET /.well-known/agent-card.json returns v0.27.0', async () => {
  ...
  test('package.json version is 0.27.0', () => {
    const pkg = require('../../package.json');
    expect(pkg.version).toBe('0.27.0');
  });
});
