...
describe('Sprint 25: Homepage Polish', () => {
  ...
  test('displays version 0.26.0', async () => {
    const res = await req(app, '/');
    expect(res.text).toContain('v0.26.0');
  });
  ...
  test('GET /health returns version 0.26.0', async () => {
  ...
  test('GET /api/stats returns version 0.26.0', async () => {
